      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: 
            CircleAvatar(
                foregroundImage: picture == null ? const NetworkImage(
              ...
              Column(
                ...
                children: [
                  ...
                  Container(constraints: const BoxConstraints(maxWidth: 250),
                    child: Expanded(child: SelectableText(body_msg,))
                    )
                ],
              ),
            ]),
          ...
          SizedBox(
            width: 50,
            child: Expanded(child: Text(data_time,overflow: TextOverflow.clip,
